...
describe User do
  ...
  describe "previous_visit_at" do
    ...
    it "should act correctly" do
      ...
      user.reload
      expect(user.previous_visit_at).to eq(first_visit_date)

      # third visit
      user.update_last_seen!(third_visit_date)
      user.reload
      expect(user.previous_visit_at).to eq(second_visit_date)
    end
  ...
  describe "update_last_seen!" do
    ...
    it "should update the last seen value" do
      ...
      user.update_last_seen!(first_visit_date)
      expect(user.reload.last_seen_at).to eq(first_visit_date)
    end

    it "should update the first seen value if it doesn't exist" do
      user.update_last_seen!(first_visit_date)
      expect(user.reload.first_seen_at).to eq(first_visit_date)
    end
  ...
  describe "last_seen_at" do
    ...
    describe 'with no previous values' do
      ...
      it "updates last_seen_at" do
        ...
        expect(user.last_seen_at).to eq(date)
      end
